...
| 3 | [&#x200B; Mijn Programma&#39;s &#x200B;](#my-programs-section) | Maakt een lijst van alle beschikbare programma&#39;s die u kunt selecteren.<br> zie [&#x200B; Programma&#39;s en de Types van Programma &#x200B;](/help/getting-started/program-setup.md) voor details op programma&#39;s. |
...
| Gebied | Beschrijving |
| --- | --- |
| ![&#x200B; toon menupictogram, hamburger &#x200B;](https://spectrum.adobe.com/static/icons/workflow_18/Smock_ShowMenu_18_N.svg) | Een drop-down menu dat toegang tot lusjes voor specifieke delen van een individueel programma verleent.<br> om het type van de dienst te bepalen uw programma heeft (AMS of AEMaaCS), zie de [&#x200B; sectie van de Kaarten van het Programma &#x200B;](#program-cards) van dit document. |
...
| *`Dynamic Account icon`* | Klik uw gebruikersbeeld om tot uw **Montages van de Rekening** en **Montages van het Programma** toegang te hebben, of uit te tekenen.<br> Als u verkoos om geen gebruikersbeeld toe te voegen, wordt een pictogram willekeurig toegewezen (zoals gezien in het toolbarbeeld hierboven). |
...
| 2 | ![&#x200B; pictogram van Info &#x200B;](/help/getting-started/assets/Info.svg) Begonnen het worden | Klik om tot de [&#x200B; op instapkaartreis &#x200B;](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/onboarding/journey/overview) toegang te hebben om u met Cloud Manager in werking te stellen.<br> De onboarding reis wordt ontworpen voor Cloud Manager op Adobe Experience Manager as a Cloud Service (AEMaaCS), en niet voor Cloud Manager op Adobe Managed Services (AMS). Veel concepten zijn echter hetzelfde. |
