...
>[!TIP]
>
>Voor details op vooraf bepaalde rollen, te zien gelieve het document [ Op rol-Gebaseerde Toestemmingen.](/help/requirements/role-based-permissions.md)
...
In deze sectie worden deze stappen beschreven. U kunt het nuttig vinden om naar de [ Termen ](#terms) en [ Configureerbare 3} secties van Toestemmingen te verwijzen aangezien u uw eigen douanetoestemmingen creeert.](#configurable-permissions)
...
1. Zoek en instantie met een naam die overeenkomt met het patroon `*-cloud-manager` en tik of klik om gebruikers en machtigingen te beheren.

1. U wordt opnieuw gericht aan het **Producten** lusje van de Admin Console, waar u gebruikers en toestemmingen voor wolkenmanager kunt beheren. Tik of klik in de Admin Console op de knop **Nieuw profiel** .
...
1. Tik of klik **sparen** wanneer volledig.
...
1. Tik of klik in de Admin Console op de naam van het [ nieuwe productprofiel dat u zojuist hebt gemaakt.](#create)
...
1. Tik of klik op **geef** verbinding van een toestemming uit om het uit te geven.
...
1. Tik of klik plus (`+`) pictogram naast het toestemmingspunt om het aan de kolom **Included Punten van de Toestemming** toe te voegen.

   * Tik of klik op het pictogram `i` naast een machtigingsitem voor meer informatie.

1. Tik of klik **toevoegen allen** knoop bij de bovenkant van de **Beschikbare kolom van Toestemmingen** om alle toestemmingen toe te voegen. Op dezelfde manier tik of klik **verwijdert al** om alle eerder geselecteerde toestemmingen te verwijderen.

1. Tik of klik **sparen** wanneer u klaar bent met het bepalen van de toestemmingspunten voor uw nieuw productprofiel.
...
1. Tik of klik in de Admin Console op de naam van het [ nieuwe productprofiel waaraan u zojuist aangepaste machtigingen hebt toegewezen.](#assign-permissions)

1. In het venster dat opent, selecteer de **Gebruikers** tabel.

1. Tik of klik **toevoegen Gebruikers** knoop en wijs gebruikers aan uw nieuw productprofiel met douanetoestemmingen toe.

Gelieve te zien sectie **gebruikers en gebruikersgroepen aan een productprofiel** van het document [ productprofielen voor ondernemingsgebruikers ](https://helpx.adobe.com/enterprise/using/manage-product-profiles.html) voor meer details op hoe te om de Admin Console te gebruiken.
...
* **Toegang van Info van de Bewaarplaats** Dit huurder/organisatieniveau toestemming staat gebruikers toe om gebruikersbenaming, wachtwoord en bewaarplaats URL voor toegang te produceren en tot klantenproject bij te dragen.
   ...
   * Gelieve te zien het document [ Bewaarplaats van de Code van Source ](/help/requirements/source-code-repository.md) voor meer informatie.
...
| Term | Beschrijving |
|---|---|
| Vooraf gedefinieerde machtigingen | Vooraf bepaalde rollen zoals **BedrijfsEigenaar**, de Manager van de Plaatsing **, enz.** om verschillende functies van Cloud Manager te besturen. Voor details op vooraf bepaalde rollen, te zien gelieve het document [ Op rol-Gebaseerde Toestemmingen.](/help/requirements/role-based-permissions.md) |
