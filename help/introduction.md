...
In de volgende secties worden de belangrijkste Cloud Manager-functies gemarkeerd.
...
U definieert toepassingsspecifieke prestatie-indicatoren (KPI&#39;s), zoals piekpaginaweergaven per minuut of verwachte responstijd voor paginabelasting. Deze KPIs fungeert als de basis voor het meten van het succes van plaatsing. Rollen en machtigingen voor verschillende teamleden kunnen eenvoudig worden gedefinieerd. De zelfbediening interface geeft u volledige controle. Het biedt ook koppelingen naar bronnen van best practices en toegang tot Adobe-experts als dat nodig is.
...
Wanneer de blauwe/groene plaatsing wordt toegelaten, verschilt de plaatsingsstroom van de standaard de plaatsingsstroom van Cloud Service.
...
| 4 | Implementatie op groene publicatieniveaus/Dispatcher-niveaus | Implementatie aan uitgever |
...
| 7 | Blauwe infrastructuur wordt verwijderd uit het productielast. | - |
