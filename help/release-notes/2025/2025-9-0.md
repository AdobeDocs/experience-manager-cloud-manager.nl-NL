...
* **Steun nu toegevoegd voor Azure DevOps (privé bewaarplaatsen)**
  ...
  Documentatie-updates bevatten configuratiestappen voor het gebruik van uw eigen kit met Azure DevOps en validatie van intrekkingsverzoeken. Zie [&#x200B; Externe Bewaarplaatsen in Cloud Manager &#x200B;](/help/managing-code/external-repositories.md) toevoegen.
