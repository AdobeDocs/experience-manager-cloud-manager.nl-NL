...
# Opmerkingen bij de release voor Cloud Manager 2026.3.0 op Adobe Managed Services {#release-notes}
...
De releasedatum voor [!UICONTROL Cloud Manager] 2026.3.0 is donderdag 5 maart 2026.
...
Een nieuw bouwstijlmodel compileert slechts veranderde modules (eerder dan de volledige repo) gebruikend module-vlakke caching om bouwstijltijden te verkorten. Zij is van toepassing op pijpleidingen voor de kwaliteit van de code en volledige stapel.
...
U controleert welke pijpleidingen gebruiken **Slimme bouwstijl**. Tijdens bèta, verschijnt deze optie slechts voor **Kwaliteit van de Code** en **Dev de Volledige pijpleidingen van de Plaatsing van de Code van de Stapel**.
